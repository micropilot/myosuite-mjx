...
class Trace:
    ...
    def render(  # noqa: C901
        ...
        for grp in groups:
            ...
            ), "Unknown group {}. Available groups {}".format(grp, self.trace.keys())
        ...
        for i_grp, grp in enumerate(groups):
            ...
            if output_format == "mp4":
                ...
                if platform == "darwin":
                    ...
                    skvideo.io.vwrite(
                        file_name_mp4, np.asarray(frames), inputdict=inputdict
                    )
                print("\nSaved: " + file_name_mp4)
            ...
            for grp_k, grp_v in self.trace.items():
                ...
                for dst_k, dst_v in grp_v.items():
                    ...
                    # numpified
                        ...
                        datum = dst_v
                        disp += "\t{}: {}, shape{}, type({})\n".format(
                            dst_k, str(type(datum)), datum.shape, datum.dtype
                        )
                disp += "}\n"
        return disp
...
def test_trace():
    ...
    trace.create_dataset(
        group_key="grp2", dataset_key="dst_k3", dataset_val={"dst_v3": [3]}
    )
    trace.create_dataset(
        group_key="grp2", dataset_key="dst_k4", dataset_val={"dst_v4": [4]}
    )
    print(trace)
