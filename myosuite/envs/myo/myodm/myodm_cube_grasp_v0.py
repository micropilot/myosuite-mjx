...
class MyoHandCubeLiftEnv(BaseV0):
    ...
    def get_obs_dict(self, sim):
        ...
        # print ("curr_hand_qpos", obs_dict["curr_hand_qpos"].shape)
        ...
        # print ("curr_obj_com", obs_dict["curr_obj_com"].shape)
        # print ("curr_obj_rot", obs_dict["curr_obj_rot"].shape)
