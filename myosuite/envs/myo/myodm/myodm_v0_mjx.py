...
class TrackEnv(BaseV0):
    ...
    def _setup(
        ...
        **kwargs
        ...
        pos = self.sys.mj_model.body_pos[self.object_bid][2]
        ipos = self.sys.mj_model.body_ipos[self.object_bid][2]
        self.lift_z = pos + ipos + self.lift_bonus_thresh
    ...
    def get_info(self, pipeline_state: base.State, info: dict) -> dict:
        ...
        info["curr_obj_rot"] = pipeline_state.xquat[self.object_bid].copy()
