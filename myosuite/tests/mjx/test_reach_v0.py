...
class TestReachV0(unittest.TestCase):
    ...
    def test_step(self):
        ...
        for action in test_actions:
            ...
            mujoco_next_obs, mujoco_reward, mujoco_done, _, mujoco_info = mujoco_env.step(action)
    ...
    def test_reward_computation(self):
        ...
        mujoco_reward_dict = mujoco_env.get_reward_dict(mujoco_env.get_obs_dict(mujoco_env.sim))
    ...
    def test_observation_space(self):
        ...
        jax_obs = jax_env.get_obs(jax_state.pipeline_state, jp.zeros(jax_env.sys.act_size()))
